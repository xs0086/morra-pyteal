...
class SimulateResponse extends basemodel_1.default {
     ...
     * be false.
     */
    constructor({ lastRound, txnGroups, version, wouldSucceed, }) {
        super();
        this.lastRound = lastRound;
    ...
    static from_obj_for_encoding(data) {
        ...
        if (typeof data['would-succeed'] === 'undefined')
            throw new Error(`Response is missing required field 'would-succeed': ${data}`);
...
class SimulateTransactionGroupResult extends basemodel_1.default {
     ...
     * happened
     */
    constructor({ txnResults, failedAt, failureMessage, }) {
        super();
...
class SimulateTransactionResult extends basemodel_1.default {
     ...
     */
    constructor({ txnResult, missingSignature, }) {
        super();
